  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0">
        <div className="absolute top-1/3 left-1/4 w-64 h-64 bg-neon-purple/10 rounded-full blur-3xl opacity-40 mix-blend-screen parallax" data-depth="2"></div>
        <div className="absolute bottom-1/4 right-1/3 w-80 h-80 bg-neon-pink/10 rounded-full blur-3xl opacity-30 mix-blend-screen parallax" data-depth="3"></div>
        <div className="absolute top-2/3 right-1/4 w-72 h-72 bg-neon-blue/10 rounded-full blur-3xl opacity-40 mix-blend-screen parallax" data-depth="1.5"></div>
      </div>
      
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 parallax" data-depth="0.3">
            <span className="glow-text">{i18n.language === 'ar' ? 'جميل شجاع' : 'Jamil Shoujah'}</span>
          </h1>

  ...
  const projects: Project[] = [
    {
      id: 1,
      title: "Sweep",
      description: "A services app connecting users with local experts in pest control, cleaning, and similar services, promoting employment of local labor forces.",
    ...
    },
    {
      id: 2,
      title: "Student Hub",
      description: "A full-stack academic platform providing students with tools to chat, share exams, and review courses.",
    ...
    },
    {
      id: 3,
      title: "Robin Hood",
      description: "A platform helping students review courses, evaluate instructors, and access past exams with secure authentication.",
    ...
    },
    {
      id: 4,
      title: "Pro-Academix",
      description: "A tutoring center webpage building a structured platform for tutors, students, and courses.",
    ...
    },
    {
      ...
      description: "A modern, responsive portfolio website showcasing my skills, experience, and projects with a sleek neon-themed design.",
    ...
    <section id="projects" className="py-20 bg-black relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 inline-block glow-text">{t('projects.title')}</h2>
                ...
                <div className={`h-2 ${
                  project.title === "Pro-Academix" 
                    ...
                    : project.title === "Developer Portfolio"
                      ...
                      : getGradientClass(`neon-${project.gradientFrom.split('-')[1]}`, `neon-${project.gradientTo.split('-')[1]}`)
                }`}></div>
                
                {/* Content */}
                <div className="p-6">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="text-xl font-bold text-white">{t(`projects.items.${project.id}.title`, project.title)}</h3>
                    <div>
                      {project.type === 'mobile' ? (
                  ...
                  <p className="text-gray-300 mb-4">{t(`projects.items.${project.id}.description`, project.description)}</p>
                  
                  {/* Tech stack */}
                  <div className="mb-6">
                    <h4 className="text-sm uppercase text-gray-500 mb-2">{t('projects.techStack')}</h4>
                  ...
                  {/* Key achievements */}
                  <div>
                    <h4 className="text-sm uppercase text-gray-500 mb-2">{t('projects.achievements')}</h4>
                    <ul className="text-sm text-gray-300">
                      {project.achievements.map((achievement, index) => (
                        <li key={index} className="flex items-start mb-1">
                          <span className="text-neon-purple mr-2">•</span>
                          <span>{t(`projects.items.${project.id}.achievements.${index}`, achievement)}</span>
                        </li>
                      ))}
                    </ul>
                  </div>
